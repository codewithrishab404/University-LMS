...
const StudentRegister = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // 2️⃣ Auto login (cookie set by backend)
      await api.post(
        "/student/login",
        { email, password },
        { withCredentials: true }
          ...
          <div className="relative z-10">
            ...
            <form onSubmit={handleRegister} className="mt-8 space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-xl bg-indigo-600 hover:bg-indigo-700 transition text-white font-semibold py-3 disabled:opacity-50"
              >
            ...
            <div className="mt-6 text-center text-sm text-gray-400">
              ...
              <Link to="/student/login" className="text-indigo-400">
                Login
              </Link>
            </div>
          </div>
